...
const EngineeringExcellence = () => {
  ...
  return (
    <section id="why-us" className="w-full px-6 md:px-12 py-20 bg-bg-primary">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              <div className="text-ervo-brown mb-5">
                {icons[index]}
              </div>
              <h3 className="text-lg font-semibold text-text-primary leading-normal">{feature.title}</h3>
            </div>
          ))}
        </div>
      </div>
